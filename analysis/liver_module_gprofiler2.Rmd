...
```{r}
dt_geneMod_comb = data.table::rbindlist(list(dt_geneMod_perslab, dt_geneMod_gerhard2018))
...
```{r}
list_pkMs <- lapply(vec_mods_assoc, function(module) {
...
names(list_pkMs)<-vec_mods_assoc
head(list_pkMs[[1]])
```

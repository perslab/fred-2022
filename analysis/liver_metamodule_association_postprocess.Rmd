---
title: 'Liver - assocication output postprocessing (for meta modules)'
...
dt_bootOut_stats_gerhard2018 <- fread(paste0(dirWGCNA_tables, prefixData, "_metamod_assoc_in_gerhard2018_201111.csv"))
```
...
```{r}
fwrite(x=dt_bootOut_stats_gerhard2018_BH, file=paste0(dirWGCNA_tables, prefixData, "_metamod_assoc_in_gerhard2018_BH_", flagDate,".csv"))

openxlsx::write.xlsx(dt_bootOut_stats_gerhard2018_BH, file=paste0(dirWGCNA_tables, prefixData, "_metamod_assoc_in_gerhard2018_BH_", flagDate,".xlsx"))
```

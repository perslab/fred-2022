...
p <- FeaturePlot(object = seuratObj, 
                 ...
                 blend = F, 
                 label = F)
saveMeta(savefnc=ggsave, plot=p,filename = here("plots",paste0(prefixData, "_", prefixRun,  "_", seuratObj@active.assay,"_CC.Difference_cellcycle_featPlot")), width=12, height=12)
```
...
saveMeta(savefnc=ggsave, plot =p2, filename = here("plots", paste0(prefixData, "_", prefixRun, "_", prefixOut, "_UMAP_sampleID.pdf")), width=20, height=12)
```

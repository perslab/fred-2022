...
```{r}
seuratObjFilter <- Seurat::SubsetData(object = seuratObj, subsetname = "percent.mito", high.threshold= 0.2) 
seuratObj
seuratObjFilter
```

```{r}
seuratObjFilter <- Seurat::SubsetData(object = seuratObj, subsetname = "percent.ribo", high.threshold= 0.2) 
seuratObj
seuratObjFilter
```
